...
1. SLM Reasoning
   Description: An absolute beginner-friendly repo on how to call LLMs and evaluate on reasoning tasks.
   Repolink: [slm_reasoning](https://github.com/ruchiradhar/llm_reasoning_project)

2. Automated Essay Grader 
   Description: A student grading prediction model with a full ML pipeline.
   Repolink: [semantic_autograder](https://github.com/ruchiradhar/semantic_autograder)

3. Image Classifier on Fashion MNIST
